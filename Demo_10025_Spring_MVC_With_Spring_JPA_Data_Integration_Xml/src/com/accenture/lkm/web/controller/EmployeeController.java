...
public class EmployeeController {
	...
	@RequestMapping(value = "/loadDeleteEmp", method = RequestMethod.GET)
	...
	public ModelAndView deleteEmployee(@ModelAttribute("empObj") EmployeeBean employeeBean) throws Exception {
		ModelAndView modelAndView = new ModelAndView();
		Integer i = employeeBean.getId();
		EmployeeBean eb = employeeService.deleteEmployeeDetails(i);
		modelAndView.setViewName("DeleteEmployeeSuccess");
		modelAndView.addObject("msg", "Employee deleted Successfully with id: "+i);
		return modelAndView;
	}
